...
float t;
float start;
DistanceStepper stepper = DistanceStepper(motorInterfaceType, stepPin_0, dirPin_0);


void setup()
{
	// create steppers array
	//stepper = DistanceStepper(motorInterfaceType, stepPin_0, dirPin_0);
